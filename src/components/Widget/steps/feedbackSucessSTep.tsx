...
export default function feedbackSucesstep({onFeedbackRestartRequested}: FeedbackSucessStepProps) {
    return (
        <>
            <header>
                <CloseButton />
            </header>
            <section className="flex flex-col items-center py-10 w-[304px]">
                ...
                className="py-2 border-transparent px-6  mt-6 leading-6 rounded-6 bg-zinc-800 hover:bg-zinc-700 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors rounded-md ">
                Quero enviar outro
                </button>
            </section>
        </>
